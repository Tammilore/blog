...
export const meta = {
  ...
  description:
    'Testing the first article. A well-crafted documentation is like a well-told story - it should be easy to follow, understand, and apply. ',
  imageUrl: '/static/images/blog/authors/han.png',
  author: 'Tamilore Lawal',
  authorRole: 'Product',
  date: 'May 19, 2023',
  category: 'OSS',
...
<img
  src="/static/images/blog/first-class-citizen/mintlify-graphic.png"
  alt="blog thumbnail"
...
[Get started](/) today to effortlessly create world-class documentation with Mintlify!
